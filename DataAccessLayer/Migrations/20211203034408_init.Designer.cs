...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Admin.AdminEntity", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Models.Customer.CustomerEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Models.Customer.CustomerEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Cart.CartEntity", b =>
                {
                    b.HasOne("Models.Customer.CustomerEntity", "CustomerEntity")
                        .WithOne("CartEntity")
            ...
            modelBuilder.Entity("Models.Product.ProductEntity", b =>
                {
                    b.HasOne("Models.Admin.AdminEntity", "Admin")
                        .WithMany("Products")
